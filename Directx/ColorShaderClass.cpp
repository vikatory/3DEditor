...
bool ColorShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	WCHAR vsFilename[32] = L"color.vs";
	WCHAR psFilename[32] = L"color.ps";
	// 初始化vs 和ps.
...
bool ColorShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, XMFLOAT4X4 worldMatrix,
...
bool ColorShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, XMFLOAT4X4 worldMatrix,
	XMFLOAT4X4 viewMatrix, XMFLOAT4X4 projectionMatrix)
{
	HRESULT result;
